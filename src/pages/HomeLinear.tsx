...
const figs: Fig[] = [
  {
    ...
    art: (
      <svg viewBox="0 0 320 260" fill="none">
        ...
        {/* connector line from chip to edge */}
  ...
  },
  {
    ...
    art: (
      <svg viewBox="0 0 320 260" fill="none">
        ...
        {/* floating agent nodes on orbits */}
        <g>
    ...
    <div className="lin-root">
      ...
      <nav className="lin-nav">
        <div className="lin-nav-inner">
          <Link to="/linear" className="lin-nav-logo" aria-label="Unifize">
        ...
        <div className="lin-cm-stage">
          ...
          >
            ...
            <g fill="none" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* LIMS → connectors → write-back (dashed, flows out) */}
            ...
            <g fill="none" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* Zoom/meetings → decisions (dashed accessory) */}
            ...
            <g>
              ...
              {/* Band divider dots on the right edge */}
